...
export type Translations = {
  ...
  closingModalBullet1: string;
  closingModalBullet2: string;
  closingModalBullet3: string;
...
const EN: Translations = {
  ...
  endTooltipActive: 'Click here to finish the interview',
  ...
  endModalWithConsent: "We'll send a summary to your email and open your insights report. You can return to the conversation at any time.",
  endModalWithoutConsent: "We'll open your insights report. You can return to the conversation at any time.",
  ...
  privacyCollectItems: [
    ...
    'Voice recordings when using the microphone — transcribed immediately and not stored',
  ],
  ...
  privacyUsedItems: [
    ...
    'Generate a personalised insights report at the end of your session',
  ...
  privacyServiceRoles: [
    'Generates all AI responses and the insights report',
    'Powers conversation memory, voice transcription, and text-to-speech',
  ...
  closingModalTitle: 'Let me make the follow-up easy.',
  closingModalSubtitle: "Drop your email and I'll send it all in one go.",
  closingModalBullet1: "Pablo's CV — PDF, ready to share with your team",
  closingModalBullet2: 'Full transcript of this conversation',
  closingModalBullet3: 'LinkedIn — to connect and stay in touch',
  closingModalConfirm: 'Send it over',
  closingModalDismiss: 'Not now',
  ...
  closingModalGdprText: "I'm happy for Pablo to email me",
  ...
  hiwTypewriterText: 'I was a Software Implementation Specialist, leading end-to-end onboarding for hotel clients across Europe…',
...
const ES: Translations = {
  ...
  q1: '¿Cuál fue tu rol más reciente?',
  ...
  endButtonShort: 'Insights',
  endButtonFull: 'Insights',
  endTooltipActive: 'Haz clic aquí para terminar la entrevista',
  ...
  endModalWithConsent: 'Te enviaremos un resumen por email y abriremos tu informe. Puedes volver a la conversación cuando quieras.',
  endModalWithoutConsent: 'Abriremos tu informe de insights. Puedes volver a la conversación cuando quieras.',
  ...
  privacyCollectItems: [
    ...
    'Grabaciones de voz al usar el micrófono — transcritas al instante y no almacenadas',
  ],
  ...
  privacyUsedItems: [
    ...
    'Generar un informe de insights personalizado al final de la sesión',
  ...
  privacyServiceRoles: [
    'Genera todas las respuestas de IA y el informe de insights',
    'Potencia la memoria, la transcripción de voz y el texto a voz',
  ...
  closingModalTitle: 'Facilita el seguimiento.',
  closingModalSubtitle: 'Deja tu email y te lo mando todo de una vez.',
  closingModalBullet1: 'CV de Pablo — PDF, listo para compartir con tu equipo',
  closingModalBullet2: 'Transcripción completa de esta conversación',
  closingModalBullet3: 'LinkedIn — para mantenernos en contacto',
  closingModalConfirm: 'Envíamelo',
  closingModalDismiss: 'Ahora no',
  ...
  closingModalGdprText: 'Me parece bien recibir este email de Pablo',
  ...
  hiwTypewriterText: 'Era Especialista en Implementación de Software, liderando el onboarding de extremo a extremo para clientes hoteleros en Europa…',
...
const IT: Translations = {
  ...
  q1: 'Qual era il tuo ruolo più recente?',
  ...
  endButtonShort: 'Insights',
  endButtonFull: 'Insights',
  endTooltipActive: 'Clicca qui per terminare il colloquio',
  ...
  endModalWithConsent: 'Ti invieremo un riepilogo via email e apriremo il tuo report. Puoi tornare alla conversazione in qualsiasi momento.',
  endModalWithoutConsent: 'Apriremo il tuo report di insights. Puoi tornare alla conversazione in qualsiasi momento.',
  ...
  privacyCollectItems: [
    ...
    'Registrazioni vocali quando si usa il microfono — trascritte immediatamente e non archiviate',
  ],
  ...
  privacyUsedItems: [
    ...
    'Generare un report insights personalizzato alla fine della sessione',
  ...
  privacyServiceRoles: [
    'Genera tutte le risposte AI e il report insights',
    'Alimenta la memoria, la trascrizione vocale e il text-to-speech',
  ...
  closingModalTitle: 'Facilito il follow-up.',
  closingModalSubtitle: 'Lascia la tua email e ti mando tutto in un colpo solo.',
  closingModalBullet1: 'CV di Pablo — PDF, pronto da condividere con il tuo team',
  closingModalBullet2: 'Trascrizione completa di questa conversazione',
  closingModalBullet3: 'LinkedIn — per restare in contatto',
  closingModalConfirm: 'Inviamelo',
  closingModalDismiss: 'Adesso no',
  ...
  closingModalGdprText: 'Sono felice di ricevere questa email da Pablo',
  ...
  hiwTypewriterText: "Ero Software Implementation Specialist, guidando l'onboarding end-to-end per clienti alberghieri in Europa…",
...
const PT: Translations = {
  ...
  q1: 'Qual foi o seu papel mais recente?',
  ...
  endButtonShort: 'Insights',
  endButtonFull: 'Insights',
  endTooltipActive: 'Clique aqui para terminar a entrevista',
  ...
  endModalWithConsent: 'Enviaremos um resumo por email e abriremos o teu relatório. Podes voltar à conversa a qualquer momento.',
  endModalWithoutConsent: 'Abriremos o teu relatório de insights. Podes voltar à conversa a qualquer momento.',
  endModalCancel: 'Cancelar',
  ...
  privacyCollectItems: [
    ...
    'Gravações de voz ao usar o microfone — transcritas imediatamente e não armazenadas',
  ],
  ...
  privacyUsedItems: [
    ...
    'Gerar um relatório de insights personalizado no final da sessão',
  ...
  privacyServiceRoles: [
    'Gera todas as respostas de IA e o relatório de insights',
    'Alimenta a memória, a transcrição de voz e o texto para fala',
  ...
  closingModalTitle: 'Vou facilitar o follow-up.',
  closingModalSubtitle: 'Deixa o teu email e mando-te tudo de uma vez.',
  closingModalBullet1: 'CV do Pablo — PDF, pronto para partilhar com a tua equipa',
  closingModalBullet2: 'Transcrição completa desta conversa',
  closingModalBullet3: 'LinkedIn — para ficar em contacto',
  closingModalConfirm: 'Envia-me',
  closingModalDismiss: 'Agora não',
  ...
  closingModalGdprText: 'Fico bem em receber este email do Pablo',
  ...
  hiwTypewriterText: 'Era Software Implementation Specialist, liderando o onboarding de ponta a ponta para clientes hoteleiros na Europa…',

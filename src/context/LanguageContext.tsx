...
const EN: Translations = {
  ...
  closingModalTitle: 'Want a follow-up from Pablo?',
  closingModalSubtitle: "I'll send you my CV, LinkedIn, and this conversation transcript.",
  closingModalConfirm: 'Yes, send it',
  closingModalDismiss: 'Skip',
  ...
  closingModalGdprText: 'I agree to receive this email from Pablo',
...
const ES: Translations = {
  ...
  closingModalTitle: '¿Quieres que Pablo te haga seguimiento?',
  closingModalSubtitle: 'Te envío mi CV, LinkedIn y la transcripción de esta conversación.',
  closingModalConfirm: 'Sí, envíalo',
  closingModalDismiss: 'Saltar',
  ...
  closingModalGdprText: 'Acepto recibir este email de Pablo',
...
const IT: Translations = {
  ...
  closingModalTitle: 'Vuoi un follow-up da Pablo?',
  closingModalSubtitle: 'Ti invio il mio CV, LinkedIn e la trascrizione di questa conversazione.',
  closingModalConfirm: 'Sì, invia',
  closingModalDismiss: 'Salta',
  ...
  closingModalGdprText: 'Acconsento a ricevere questa email da Pablo',
...
const PT: Translations = {
  ...
  closingModalTitle: 'Queres receber um follow-up de Pablo?',
  closingModalSubtitle: 'Envio-te o meu CV, LinkedIn e a transcrição desta conversa.',
  closingModalConfirm: 'Sim, envia',
  closingModalDismiss: 'Saltar',
  ...
  closingModalGdprText: 'Concordo em receber este email de Pablo',
